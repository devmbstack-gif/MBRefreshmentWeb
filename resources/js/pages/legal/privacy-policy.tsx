...
export default function PrivacyPolicy({ title, text, updated_at }: Props) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-cyan-50/30 text-slate-900">
                <header className="border-b border-cyan-100/80 bg-white/90 backdrop-blur">
                ...
                <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
                    <div className="mb-10 flex items-start gap-4">
                        <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-emerald-600 text-white shadow-lg shadow-cyan-500/25">
