                    ...
                    <div className="flex flex-col gap-6 px-6 py-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-2 text-sm leading-6 text-slate-600">
                                ...
                                . Track allowances across your plans. Use the
                                header search when you need to find a page
                                quickly.
                            </p>
                        </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                            Tap &quot;Use 1&quot; when you take an item from
                            your allowance.
                        </p>
                    </div>
                ...
                {quotas.length === 0 ? (
                    <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-200 bg-white py-20 text-center shadow-sm">
                        ...
                        <p className="mt-2 max-w-sm text-sm text-slate-500">
                            Contact your administrator if you expect to see
                            allowances here.
                        </p>
                    </div>
                ) : (
                            ...
                            <div className="bg-white/40 px-6 pt-4 pb-1">
                                ...
                                >
                                    ...
                                    <p className="mt-3 text-lg font-bold text-white">
                                        {confirmQuota.item_name}
                                    </p>
                                    <p className="text-sm text-white/90">
                                        {confirmQuota.plan_title}
                                    </p>
                                </div>
                                <p className="mt-4 text-sm leading-relaxed text-slate-600">
                                    You have{' '}
                                    <strong className="text-slate-900">
                                        {confirmQuota.remaining_qty}
                                    </strong>{' '}
                                    remaining
...
function QuotaCard({ quota, onUse }: { quota: Quota; onUse?: () => void }) {
    ...
    const isLow =
        quota.remaining_qty <= 1 && isActive && quota.remaining_qty > 0;
        ...
        <div className="group overflow-hidden rounded-3xl border border-slate-200/90 bg-white shadow-sm transition-all hover:-translate-y-0.5 hover:border-emerald-200/60 hover:shadow-md">
            ...
            >
                {quota.item_image_url ? (
                    ...
                    <span
                        className="text-6xl drop-shadow-lg transition-transform duration-300 group-hover:scale-105"
                        aria-hidden
                    >
                        {cat.emoji}
                    </span>
                ...
                <span
                    className={`absolute top-3 left-3 inline-flex items-center rounded-full ${cat.pill} px-2.5 py-1 text-xs font-semibold text-white shadow`}
                >
                    {cat.label}
                </span>
                <span
                    className={`absolute top-3 right-3 inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold shadow ${
                        isActive
                ...
                {isLow && (
                    <span className="absolute right-3 bottom-3 inline-flex items-center gap-1 rounded-full bg-amber-400 px-2.5 py-1 text-xs font-bold text-amber-950 shadow">
                ...
                <div className="mt-4">
                    ...
                    >
                        <div
                            ...
                            style={{
                                width: `${Math.min(100, Math.max(0, quota.percentage_used))}%`,
                            }}
                        />
                    </div>
                </div>
